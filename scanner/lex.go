...
{tok = RESUMED; {( lex.p)++;  lex.cs = 174; goto _out }}
	goto st174
tr241:
//line scanner/lex.rl:85
 lex.te = ( lex.p)
( lex.p)--
{tok = EQUALS;{( lex.p)++;  lex.cs = 174; goto _out }}
	goto st174
tr242:
//line scanner/lex.rl:86
 lex.te = ( lex.p)+1
{tok = LEQUAL; {( lex.p)++;  lex.cs = 174; goto _out }}
	goto st174
tr243:
//line scanner/lex.rl:103
 lex.te = ( lex.p)+1
{tok = ARROW; {( lex.p)++;  lex.cs = 174; goto _out }}
	goto st174
tr244:
//line scanner/lex.rl:79
 lex.te = ( lex.p)
( lex.p)--
{out.data = string(lex.data[lex.ts:lex.te]); tok = IDENTIFIER;{( lex.p)++;  lex.cs = 174; goto _out }}
	goto st174
tr249:
//line scanner/lex.rl:77
 lex.te = ( lex.p)
( lex.p)--
{out.data = string(lex.data[lex.ts:lex.te]); tok = FLAG; {( lex.p)++;  lex.cs = 174; goto _out }}
	goto st174
tr263:
//line scanner/lex.rl:95
 lex.te = ( lex.p)
( lex.p)--
{tok = OR;{( lex.p)++;  lex.cs = 174; goto _out }}
	goto st174
tr264:
//line scanner/lex.rl:104
 lex.te = ( lex.p)+1
